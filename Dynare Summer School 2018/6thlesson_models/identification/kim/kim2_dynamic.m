...
T102 = (-(exp(x(it_, 2))*(-(T81*getPowerDeriv(y(2),1+params(6),1)))/(T82*T82)/(1+params(6))));
...
T128 = T35*getPowerDeriv(y(3),(1+params(6))*params(1)-1,1)+T47*(1+params(6))*(1-params(3))*T122*T123;
T131 = 1/T20;
T134 = y(6)*(1+params(6))*T131*getPowerDeriv(T21,params(6),1);
T136 = 1/y(3)/params(3);
...
T289 = T92*T288;
lhs =T23*T28;
rhs =params(2)*y(9)*T49;
residual(1)= lhs-rhs;
lhs =y(3);
rhs =T59^(1/(1-params(7)));
residual(2)= lhs-rhs;
lhs =T70^(1/(1+params(6)));
rhs =y(5)*y(1)^params(1);
residual(3)= lhs-rhs;
lhs =y(5);
...
if nargout >= 2,
  ...
  g1(1,3)=T23*T114*T115-params(2)*y(9)*T128;
  g1(1,4)=T28*T134+T23*T115*T136;
  g1(1,7)=(-(params(2)*y(9)*(T47*(1+params(6))*(1-params(3))*T123*T136+T45*T155)));
  g1(1,8)=(-(params(2)*y(9)*T37*(1+params(6))*params(1)*getPowerDeriv(y(8),1+params(6),1)));
  ...
  g1(2,4)=(-(T105*T144));
  g1(3,2)=T92*T93;
  g1(3,1)=(-(y(5)*getPowerDeriv(y(1),params(1),1)));
  g1(3,4)=T93*T149;
  g1(3,5)=(-(y(1)^params(1)));
  g1(4,5)=1;
  g1(4,10)=(-1);
...
if nargout >= 3,
  ...
  v2(1,1)=1;
  v2(1,2)=25;
  v2(1,3)=T23*(T115*(-((-y(4))*(y(3)+y(3))))/(y(3)*y(3)*y(3)*y(3))/params(3)+T114*T114*getPowerDeriv(T26,params(7),2))-params(2)*y(9)*(T35*getPowerDeriv(y(3),(1+params(6))*params(1)-1,2)+T47*(1+params(6))*(1-params(3))*(T123*(-((-y(7))*(y(3)+y(3))))/(y(3)*y(3)*y(3)*y(3))/params(3)+T122*T122*getPowerDeriv(T42,params(7),2)));
  v2(2,1)=1;
  v2(2,2)=36;
  v2(2,3)=T114*T115*T134+T23*(T136*T114*getPowerDeriv(T26,params(7),2)+T115*T203);
  v2(3,1)=1;
  v2(3,2)=26;
  v2(3,3)=  v2(2,3);
  v2(4,1)=1;
  v2(4,2)=37;
  v2(4,3)=T134*T115*T136+T28*y(6)*(1+params(6))*T131*T131*getPowerDeriv(T21,params(6),2)+T134*T115*T136+T23*T136*T136*getPowerDeriv(T26,params(7),2);
  v2(5,1)=1;
  v2(5,2)=69;
  v2(5,3)=(-(params(2)*y(9)*(T47*(1+params(6))*(1-params(3))*(T136*T122*getPowerDeriv(T42,params(7),2)+T123*T203)+(1+params(6))*(1-params(3))*T122*T123*T155)));
  v2(6,1)=1;
  v2(6,2)=29;
  v2(6,3)=  v2(5,3);
  v2(7,1)=1;
  v2(7,2)=73;
  v2(7,3)=(-(params(2)*y(9)*((1+params(6))*(1-params(3))*T123*T136*T155+T47*(1+params(6))*(1-params(3))*T136*T136*getPowerDeriv(T42,params(7),2)+(1+params(6))*(1-params(3))*T123*T136*T155+T45*T131*T131*getPowerDeriv(y(7)/T20,params(6),2))));
  v2(8,1)=1;
  v2(8,2)=80;
  v2(8,3)=(-(params(2)*y(9)*getPowerDeriv(y(3),(1+params(6))*params(1)-1,1)*(1+params(6))*params(1)*getPowerDeriv(y(8),1+params(6),1)));
  v2(9,1)=1;
  v2(9,2)=30;
  v2(9,3)=  v2(8,3);
  v2(10,1)=1;
  ...
  v2(13,1)=1;
  v2(13,2)=59;
  v2(13,3)=T115*T136*(1+params(6))*T22+T28*(1+params(6))*T131*getPowerDeriv(T21,params(6),1);
  v2(14,1)=1;
  v2(14,2)=39;
  v2(14,3)=  v2(13,3);
  v2(15,1)=1;
  v2(15,2)=91;
  v2(15,3)=(-(params(2)*T128));
  v2(16,1)=1;
  v2(16,2)=31;
  v2(16,3)=  v2(15,3);
  v2(17,1)=1;
  ...
  v2(19,1)=1;
  v2(19,2)=96;
  v2(19,3)=(-(params(2)*T37*(1+params(6))*params(1)*getPowerDeriv(y(8),1+params(6),1)));
  v2(20,1)=1;
  v2(20,2)=86;
  v2(20,3)=  v2(19,3);
  v2(21,1)=2;
  ...
  v2(30,1)=3;
  v2(30,2)=45;
  v2(30,3)=(-(getPowerDeriv(y(1),params(1),1)));
  v2(31,1)=3;
  v2(31,2)=5;
  v2(31,3)=  v2(30,3);
  v2(32,1)=5;
  v2(32,2)=13;
  v2(32,3)=(-(exp(x(it_, 2))*(T82*T82*(-(T81*getPowerDeriv(y(2),1+params(6),2)))-(-(T81*getPowerDeriv(y(2),1+params(6),1)))*(T82*getPowerDeriv(y(2),1+params(6),1)+T82*getPowerDeriv(y(2),1+params(6),1)))/(T82*T82*T82*T82)/(1+params(6))));
  v2(33,1)=5;
  v2(33,2)=112;
  v2(33,3)=T102;
  v2(34,1)=5;
