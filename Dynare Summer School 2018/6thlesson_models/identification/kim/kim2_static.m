...
T42 = T34*T36+T22*(1+params(6))*T28*(1-params(3));
...
T99 = T97*T98;
T106 = T34*getPowerDeriv(y(2),(1+params(6))*params(1)-1,1)+T22*(1+params(6))*(1-params(3))*T99;
...
T164 = T98*(-((-y(3))*(y(2)+y(2))))/(y(2)*y(2)*y(2)*y(2))/params(3)+T97*T97*getPowerDeriv(T26,params(7),2);
T179 = T122*T97*getPowerDeriv(T26,params(7),2)+T98*(-1)/(y(2)*y(2))/params(3);
T232 = getPowerDeriv(T51,1/(1-params(7)),2);
T233 = T110*T232;
T253 = getPowerDeriv(T62,1/(1+params(6)),2);
T254 = T83*T253;
lhs =y(5)*(1+params(6))*T22*T28;
rhs =y(5)*params(2)*T42;
residual(1)= lhs-rhs;
lhs =y(2);
rhs =T51^(1/(1-params(7)));
residual(2)= lhs-rhs;
lhs =T62^(1/(1+params(6)));
rhs =y(4)*y(2)^params(1);
residual(3)= lhs-rhs;
lhs =y(4);
rhs =params(4)+x(1);
residual(4)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(1,2)=y(5)*(1+params(6))*T22*T99-y(5)*params(2)*T106;
  ...
  g1(1,4)=(-(y(5)*params(2)*T36*(1+params(6))*params(1)*getPowerDeriv(y(4),1+params(6),1)));
  g1(1,5)=T28*(1+params(6))*T22-params(2)*T42;
  g1(2,2)=1-T110*T111;
  g1(2,3)=(-(T111*T137));
  g1(3,1)=T83*T84;
  g1(3,2)=(-(y(4)*getPowerDeriv(y(2),params(1),1)));
  g1(3,3)=T84*T142;
  g1(3,4)=(-(y(2)^params(1)));
  g1(4,4)=1;
  g1(5,1)=(-(exp(x(2))*(-(T72*getPowerDeriv(y(1),1+params(6),1)))/(T73*T73)/(1+params(6))));
  g1(5,5)=1;
  if ~isreal(g1)
...
if nargout >= 3,
  ...
  v2(4,1)=1;
  v2(4,2)=13;
  v2(4,3)=y(5)*(1+params(6))*T119*T123+T28*y(5)*(1+params(6))*T117*T117*getPowerDeriv(T21,params(6),2)+y(5)*(1+params(6))*T119*T123+y(5)*(1+params(6))*T22*T122*T122*getPowerDeriv(T26,params(7),2)-y(5)*params(2)*(T119*(1+params(6))*(1-params(3))*T123+(1+params(6))*T28*(1-params(3))*T117*T117*getPowerDeriv(T21,params(6),2)+T119*(1+params(6))*(1-params(3))*T123+T22*(1+params(6))*(1-params(3))*T122*T122*getPowerDeriv(T26,params(7),2));
  v2(5,1)=1;
  v2(5,2)=17;
  v2(5,3)=(-(y(5)*params(2)*getPowerDeriv(y(2),(1+params(6))*params(1)-1,1)*(1+params(6))*params(1)*getPowerDeriv(y(4),1+params(6),1)));
  v2(6,1)=1;
  v2(6,2)=9;
  v2(6,3)=  v2(5,3);
  v2(7,1)=1;
  ...
  v2(8,1)=1;
  v2(8,2)=22;
  v2(8,3)=T99*(1+params(6))*T22-params(2)*T106;
  v2(9,1)=1;
  v2(9,2)=10;
  v2(9,3)=  v2(8,3);
  v2(10,1)=1;
  ...
  v2(12,1)=1;
  v2(12,2)=24;
  v2(12,3)=(-(params(2)*T36*(1+params(6))*params(1)*getPowerDeriv(y(4),1+params(6),1)));
  v2(13,1)=1;
  v2(13,2)=20;
  v2(13,3)=  v2(12,3);
  v2(14,1)=2;
  ...
  v2(23,1)=3;
  v2(23,2)=17;
  v2(23,3)=(-(getPowerDeriv(y(2),params(1),1)));
  v2(24,1)=3;
  v2(24,2)=9;
  v2(24,3)=  v2(23,3);
  v2(25,1)=5;
  v2(25,2)=1;
  v2(25,3)=(-(exp(x(2))*(T73*T73*(-(T72*getPowerDeriv(y(1),1+params(6),2)))-(-(T72*getPowerDeriv(y(1),1+params(6),1)))*(T73*getPowerDeriv(y(1),1+params(6),1)+T73*getPowerDeriv(y(1),1+params(6),1)))/(T73*T73*T73*T73)/(1+params(6))));
